...
//	Default values
	static String username = "yaman.maharjan@javra.com";
	static String password = "!wertyu$@AQW";
...
//			attachment.setName("RFQ.json");
	...
	public static void sendReportAndLog(String username, String password,String to, String cc,  String subject, String message, String reportPath, String logPath) {
		try {
			// Create an HtmlEmail object
			HtmlEmail email = new HtmlEmail();
			...
			// Create an EmailAttachment object and add it to the email
			EmailAttachment attachmentReport = new EmailAttachment();
			attachmentReport.setPath(reportPath);
			attachmentReport.setDisposition(EmailAttachment.ATTACHMENT);
			email.attach(attachmentReport);
			
			EmailAttachment attachmentLog = new EmailAttachment();
			attachmentLog.setPath(logPath);
			attachmentLog.setDisposition(EmailAttachment.ATTACHMENT);
			email.attach(attachmentLog);
